  ...
  $(document).ready(function () {
      ...
      cvijece = ["diviti se","čuditi se","zahvaljivati","radovati se","nadati se","prigovarati","pokloniti","pisati","veseliti se","govoriti","vjerovati","smijati se","kazati","slati","približavati se","dati","pomagati","smetati",]
      // QUIZ CONTENT ------
      ...
      newQuiz = function () {
          ...
          if (uglata == 1) {
              quiz = [{
                  question: "_____ znači izražavati iznimno poštovanje prema komu ili čemu.",
                  ...
                  opis: "Diviti se znači izražavati iznimno poštovanje prema komu ili čemu.",
