...
document.getElementsByClassName('sakri')[0].style.display = "flex"
  ...
  p1 = [{
      question: "<span class='nadopuni prvoslovo'>_______</span> znači izreći kakvu priču, reći sve što se zna o čemu, opisati što u cijelosti.",
      answers: ["ispričati", "pričati",""],
      correctAnswer: "ispričati",
      boja_pozadine: "#FCE4EC"
  }, {
      question: "<span class='nadopuni prvoslovo'>_______</span> znači zabilježiti što slovima, brojkama ili kakvim drugim znakovima.",
      answers: ["napisati", "pisati",""],
      correctAnswer: "napisati",
      boja_pozadine: "#FCE4EC"
  }, {
    question: "<span class='nadopuni prvoslovo'>_______</span> znači pripremati sirovu hranu u pećnici ili na vatri, najčešće bez dodatka tekućine ili vode.",
    answers: ["ispeći", "peći",""],
    correctAnswer: "peći",
    boja_pozadine: "#FCE4EC"
}, {
    question: "<span class='nadopuni prvoslovo'>_______</span> znači iznositi kakav sadržaj ili misli u pisanome obliku, oblikovati kakav tekst.",
    answers: ["napisati", "pisati",""],
    correctAnswer: "pisati",
    boja_pozadine: "#FCE4EC"
}, {
    question: "<span class='nadopuni prvoslovo'>_______</span> znači bilježiti slovima, brojkama ili znakovima na kakvu podlogu.",
    answers: ["napisati", "pisati",""],
    correctAnswer: "pisati",
    boja_pozadine: "#FCE4EC"
}, {
    question: "<span class='nadopuni prvoslovo'>_______</span> znači činiti zapis u čemu, bilježiti podatke u što.",
    answers: ["unositi", "nositi",""],
    correctAnswer: "unositi",
    boja_pozadine: "#FCE4EC"
},  {
    question: "<span class='nadopuni prvoslovo'>_______</span> znači ne odvajajući što od površine pomicati privlačeći prema sebi.",
    answers: ["povući", "vući",""],
    correctAnswer: "vući",
    boja_pozadine: "#FCE4EC"
}];
