...
function CheckClick() {
	...
	if (ErrorsFound > 0 && EmptyFound > 0) {
		document.getElementById("welcomemessage").innerHTML = "Nisi sve točno riješio." + "<br />" + "broj pogrešaka: " + ErrorsFound + "<br />" + "broj neispunjenih polja: " + EmptyFound + "<br><p style='text-align:center'><a href='index.html'>nova igra</a> <img src='rjesenje.png' style='max-width:100%;height:auto'></p>";
		$("#answerbox").hide()
	} else if (ErrorsFound > 0) {
		document.getElementById("welcomemessage").innerHTML = "Nisi sve točno riješio.\n broj pogrešaka: " + ErrorsFound + "<br><p style='text-align:center'><a href='index.html'>nova igra</a><img src='rjesenje.png' style='max-width:100%;height:auto'></p>";
		$("#answerbox").hide()

	} else if (EmptyFound > 0) {
		document.getElementById("welcomemessage").innerHTML = "Nema pogrešaka, ali je broj neispunjenih polja: " + EmptyFound + "<br><p style='text-align:center'><a href='index.html'>nova igra</a><img src='rjesenje.png' style='max-width:100%;height:auto'></p>";
		$("#answerbox").hide()
	}
